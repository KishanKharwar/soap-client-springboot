...
// Generated on: 2022.04.20 at 11:53:08 PM IST 
//


package com.web.service.soap.client.wsdl;
 ...
 * generated in the com.web.service.soap.client.wsdl package.
...
public class ObjectFactory {
  ...
  private final static QName _GetBankResponse_QNAME = new QName("http://thomas-bayer.com/blz/",
      "getBankResponse");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: com.web.service.soap.client.wsdl
   */
   ...
   * @return the new instance of {@link JAXBElement }{@code <}{@link GetBankType }{@code >}
   */
   ...
   *
   * @param value Java instance representing xml element's value.
   * @return the new instance of {@link JAXBElement }{@code <}{@link GetBankResponseType }{@code >}
   */
  ...
  public JAXBElement<GetBankResponseType> createGetBankResponse(GetBankResponseType value) {
    return new JAXBElement<GetBankResponseType>(_GetBankResponse_QNAME, GetBankResponseType.class,
        null, value);
  }
